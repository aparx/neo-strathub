...
export interface CircleTransformerProps
  extends BaseTransformerData<CircleConfig> {
  onUpdateConfig: Dispatch<SetStateAction<CircleConfig>>;
}

/** The debounce time until a *specific* config field update is committed */
const CONFIG_FIELD_DEBOUNCE_MS = 500;

export const CircleTransformer = forwardRef<
  Konva.Transformer,
  CircleTransformerProps
>(function CircleTransformer({ config, onUpdateConfig, ...restProps }, ref) {
